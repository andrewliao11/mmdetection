...
class ExtractFeatDETR(DETR):
    ...
    def simple_test(self, img, img_metas, rescale=False):
        ...
        bbox_results = []
        for det_bboxes, det_labels, encoder_feats in results_list:
            res = bbox2result(det_bboxes, det_labels, self.bbox_head.num_classes)
            res.append(encoder_feats)
